...
Both groups are different from control, and we can see in the table that the terminal group and cursorjump group have more than twice the amount of explicit strategy as compared to the control group.
