...
```{r}
expFitBF(exp=1,type='reaches',mode='washout')
```
...
```{r}
expFitBF(exp=1,type='nocursors',mode='washout')
```
...
```{r}
expFitBF(exp=2,type='reaches')
```

Here are the Bayesian F-tests on rate of change and asymptote of no-cursors:

```{r}
expFitBF(exp=2, type='nocursors')
```
...
```{r}
expFitBF(exp=3,type='reaches')
```

Here are the Bayesian F-tests on rate of change and asymptote of no-cursors:

```{r}
expFitBF(exp=3, type='nocursors')
```
...
```{r}
expFitBF(exp=4,type='reaches')
```

Here are the Bayesian F-tests on rate of change and asymptote of no-cursors:

```{r}
expFitBF(exp=4, type='nocursors')
```
