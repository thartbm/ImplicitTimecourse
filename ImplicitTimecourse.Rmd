...
# Subtractive estimate if implicit adaptation

What if we _do_ subtract explicit aiming reports from total adaptation to get this indirect estimate of implicit adaptation? (Even though in every single group we see that that is not necessarily a good idea.) We do this with the continuous aiming group only, and first look at various plots of the data.
