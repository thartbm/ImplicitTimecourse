...
Both groups are different from control, and we can see in the table and figure that the terminal group and cursor-jump group have almost twice the amount of explicit strategy as compared to the control group.
